        ...
        <form onSubmit={handleSubmit(onFormSubmit)} className="p-6 space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              />
              {errors.entryPrice && (
                <p className="text-red-600 text-sm mt-1">{errors.entryPrice.message}</p>
              )}
            </div>
            ...
            <div>
              ...
              />
              {errors.entryDate && (
                <p className="text-red-600 text-sm mt-1">{errors.entryDate.message}</p>
              )}
            </div>
            ...
            {status === 'closed' && (
              <>
                <div>
                  ...
                  />
                  {errors.exitPrice && (
                    <p className="text-red-600 text-sm mt-1">{errors.exitPrice.message}</p>
                  )}
                </div>
