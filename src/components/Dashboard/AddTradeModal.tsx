...
const AddTradeModal: React.FC<AddTradeModalProps> = ({ 
  ...
  return (
    <div className="fixed inset-0 z-[9999] bg-black bg-opacity-50 backdrop-blur-sm">
      {/* CRITICAL: Scrollable container with proper positioning */}
      <div className="h-full overflow-y-auto scrollbar-thin">
        <div className="min-h-full flex items-start justify-center p-4 pt-8 pb-16">
          <div 
            ref={modalRef}
            className="relative bg-white dark:bg-gray-800 rounded-xl w-full max-w-4xl border border-gray-200 dark:border-gray-700 shadow-2xl animate-fade-in-scale my-auto"
          >
            {/* Fixed Header */}
            ...
            <div className="max-h-[calc(100vh-200px)] overflow-y-auto scrollbar-thin">
              <form ref={formRef} onSubmit={handleSubmit(onFormSubmit)} className="p-6 space-y-6">
                ...
                {/* CRITICAL: Action Buttons - Always Visible at Bottom */}
                <div className="flex justify-end space-x-4 pt-6 border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 sticky bottom-0 z-10 -mx-6 px-6 pb-6 rounded-b-xl">
                  <button
                    type="button"
                    onClick={onClose}
