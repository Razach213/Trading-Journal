...
const AddTradeModal: React.FC<AddTradeModalProps> = ({ 
  ...
  useEffect(() => {
    // Immediately scroll to top to ensure modal is visible
  ...
  // CRITICAL: Prevent body scroll and ensure modal is on top
  useEffect(() => {
  ...
  return (
    <div className="fixed inset-0 z-[9999] bg-black bg-opacity-50 backdrop-blur-sm">
      {/* CRITICAL: Modal positioned at viewport center */}
      <div className="fixed inset-0 flex items-center justify-center p-4 overflow-y-auto">
        <div 
          ref={modalRef}
          className="relative bg-white dark:bg-gray-800 rounded-xl w-full max-w-4xl max-h-[95vh] overflow-y-auto border border-gray-200 dark:border-gray-700 shadow-2xl animate-fade-in-scale"
          style={{ 
