...
const StartingBalanceModal: React.FC<StartingBalanceModalProps> = ({ 
  ...
  return (
    <div className="fixed inset-0 z-[9999] bg-black bg-opacity-50 backdrop-blur-sm overflow-y-auto">
      <div className="min-h-screen pt-4 pb-8 px-4">
        <div 
          ref={modalRef}
          className="relative bg-white dark:bg-gray-800 rounded-xl w-full max-w-lg mx-auto border border-gray-200 dark:border-gray-700 shadow-2xl animate-fade-in-scale"
          style={{ 
