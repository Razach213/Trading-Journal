...
const StartingBalanceModal: React.FC<StartingBalanceModalProps> = ({ 
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 overflow-y-auto">
      ...
      <div 
        ref={modalRef}
        className="relative bg-white dark:bg-gray-800 rounded-xl max-w-lg w-full border border-gray-200 dark:border-gray-700 shadow-2xl animate-fade-in-scale my-8"
        style={{ 
