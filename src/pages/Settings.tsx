                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        ...
                        {profileErrors.displayName && (
                          <p className="text-red-600 text-sm mt-1">{profileErrors.displayName.message}</p>
                        )}
                      </div>
              ...
              {activeTab === 'notifications' && (
                <div className="p-6">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        <h3 className="font-medium text-gray-900">Trade Reminders</h3>
                        <p className="text-sm text-gray-600">Get reminded to log your trades</p>
                      </div>
                      <button
                        onClick={() => handleNotificationChange('tradeReminders')}
                        className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                          notifications.tradeReminders ? 'bg-blue-600' : 'bg-gray-200'
                        }`}
                      >
                        <span
                          className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        <h3 className="font-medium text-gray-900">Performance Updates</h3>
                        <p className="text-sm text-gray-600">Weekly performance summaries</p>
                      </div>
                      <button
                        onClick={() => handleNotificationChange('performanceUpdates')}
                        className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                          notifications.performanceUpdates ? 'bg-blue-600' : 'bg-gray-200'
                        }`}
                      >
                        <span
                          className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-gray-600">Important market updates and news</p>
                      </div>
                      <button
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="border-t border-gray-200 pt-6">
                      ...
                      <div className="space-y-4">
                        <div className="flex items-center justify-between">
                          <div>
                            <p className="font-medium text-gray-900">Make trades public by default</p>
                            <p className="text-sm text-gray-600">New trades will be visible to the community</p>
                          </div>
