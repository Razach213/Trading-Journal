            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-orange-700 dark:text-orange-300 mt-1">
                  Firebase is not configured. Your account will be created in demo mode and data won't be saved permanently.
                </p>
                <p className="text-xs text-orange-600 dark:text-orange-400 mt-2">
                  To enable full functionality, please configure Firebase in your .env file.
                </p>
              </div>
            </div>
          </div>
            ...
            <div>
              ...
              >
                {isLoading ? (
                  ...
                  <>
                    {isDemoMode ? 'Create Demo Account' : 'Create account'}
                  </>
                )}
              </button>
            </div>
            ...
            <div className="mt-6">
              ...
              <div className="mt-6">
                ...
                >
                  ...
                  <span className="ml-2">
                    {isDemoMode ? 'Demo Google Sign up' : 'Sign up with Google'}
                  </span>
                </button>
              </div>
            </div>
